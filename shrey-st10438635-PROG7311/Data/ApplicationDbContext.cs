    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Contract>().HasData(
                new Contract
                {
                    Id = 1, ClientId = 1, Title = "SA Distribution Contract",
                    StartDate = new DateTime(2024, 1, 1), EndDate = new DateTime(2026, 12, 31),
                    Status = ContractStatus.Active, ServiceLevel = ServiceLevel.Premium,
                    CreatedAt = new DateTime(2024, 1, 1)
                },
                new Contract
                {
                    Id = 2, ClientId = 2, Title = "EU Express Freight",
                    StartDate = new DateTime(2023, 6, 1), EndDate = new DateTime(2024, 5, 31),
                    Status = ContractStatus.Expired, ServiceLevel = ServiceLevel.Express,
